...
const WorkReport = () => {
  ...
  const apiBaseUrl =
    "https://management-system-he71.onrender.com/api/report/workereportCreate"; // URL to fetch data
  ...
  const fetchWorkReports = async () => {
    try {
      ...
      const response = await axios.get(
        `https://management-system-he71.onrender.com/api/report/singaleReport/${id}`,
        {
          headers: {
