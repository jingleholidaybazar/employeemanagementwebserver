...
const Department = () => {
    ...
    const fetchDepartments = async () => {
      ...
      try {
        const response = await axios.get(
          "https://management-system-te7m.onrender.com/api/department/getDepartment"
        );
  ...
  const handleDelete = async (_id) => {
    ...
    try {
      await axios.delete(
        `https://management-system-te7m.onrender.com/api/department/deleteDepartment/${_id}`
      );
      setDepartments(
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(
        `https://management-system-te7m.onrender.com/api/department/updateDepartment/${currentDepartment._id}`,
