...
const Attendance = () => {
    ...
    const fetchAttendance = async () => {
      try {
        ...
        const response = await axios.get(
          `https://employeemanagment-trda.onrender.com/api/attendance/getAttendance/${userId}/${formattedMonth}`,
  ...
  const markAttendance = async (type) => {
    try {
      const response = await axios.post(
        "https://employeemanagment-trda.onrender.com/api/attendance/markAttendance",
        { date: today, type },
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const downloadPdf = async () => {
    ...
    const apiUrl = `https://employeemanagment-trda.onrender.com/api/attendance/getAllMonthRecords/${userId}`;
