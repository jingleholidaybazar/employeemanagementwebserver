...
function AuthContextProvider({ children }) {
  ...
  const apiBaseUrl = "https://management-system-te7m.onrender.com"; // Use development URL by default
  ...
  const fetchAttendance = async () => {
    try {
      ...
      const response = await axios.get(
        "https://management-system-te7m.onrender.com/api/attendance/allAttendance", // Pass the employee ID in the URL path
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
